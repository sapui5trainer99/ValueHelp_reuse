		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Value_help_resue",
									"targetURL": "#valuehelpresuevaluehelpresue-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"valuehelpresuevaluehelpresue-display": {
								"semanticObject": "valuehelpresuevaluehelpresue",
								"action": "display",
								"description": "Value_help_resue",
								"title": "Value_help_resue",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=valuehelpresue.valuehelpresue",
									"url": sap.ui.require.toUrl("valuehelpresue/valuehelpresue")
								}
							}
						}
					}
